<template>
  <Section>
    ...
    <Card1 year="2017-Pres."
      ...
      <template slot="description"><a href="http://ckip.iis.sinica.edu.tw" target="_blank">CKIP Lab</a>, <a href="//www.iis.sinica.edu.tw/index_en.html" target="_blank">Institute of Information Science</a>,<br />Academia Sinica, Taipei, Taiwan</template>
    </Card1>
    ...
    <Collapse name="employment-more">
      ...
      <Card1 year="2016-2016"
             ...
             institution="Nat'l. Taiwan Univ."
             img-src="/img/ntu_logo.png">
        <template slot="description">Supervised by Prof. Semin Kim<br /><a href="http://www.econ.ntu.edu.tw/?locale=en" target="_blank">Department of Economics</a>, National Taiwan University, Taipei, Taiwan<br /><i>conducting researches of ordinal versus cardinal voting rules</i></template>
      </Card1>
