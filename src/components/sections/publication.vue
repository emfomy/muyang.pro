  ...
  <Section class="Publication">
    ...
    >
      <header>
        ...
        <p>
          Mu Yang, Chi-Yen Chen, Yi-Hui Lee, Qian-Hui Zeng, Wei-Yun Ma,
          Chen-Yang Shih, Wei-Jhih Chen<br />2020, 12th International Conference
    ...
    >
      <header>
        ...
        <p>
          Jhih-Sheng Fan, Mu Yang, Peng-Hsuan Li, Wei-Yun Ma<br />2019, 13th
          IEEE International Conference on Semantic Computing (IEEE-ICSC'19)
        </p>
      </header>
    ...
    >
      <header>
        ...
        <p>
          Mu Yang, Ray-Bing Chen, I-Hsin Chung, Weichung Wang<br />2016, 16th
    ...
    <Collapse ref="collapse" name="publication-more" class="mt-4">
      ...
      >
        <header>
          ...
          <p>
            Mu Yang, Weichung Wang<br />2016, 7th Taiwan-Japan Joint Workshop
